...
| Email | Shared inboxes, internal email | |
...
| Bookmarks/Links | Shared team link library | |
...
| Incident Management | Alerts, on-call rotation (PagerDuty-like) | |
...
| Secrets Vault | Credentials and secrets storage | |
...
| Polls / Surveys | Team feedback collection | |
| Announcements / Newsletter | Company-wide communications | |
